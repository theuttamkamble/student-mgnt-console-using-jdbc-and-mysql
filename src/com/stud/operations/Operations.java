package com.stud.operations;

import java.sql.ResultSet;
import java.sql.SQLException;
import java.util.Scanner;

import com.stud.stmt.StatementObj;
...
public class Operations {
	...
	public static void displayAll() throws ClassNotFoundException, SQLException {
		...
		ResultSet rs = StatementObj.getStmt().executeQuery(select);
	...
	public static void createStudent() throws ClassNotFoundException, SQLException {
		...
		for (int i = 1; i <= opt; i++) {
			...
			StatementObj.getStmt().executeUpdate(insert);
			System.out.println();
		}
...
//	 Delete a Student
	public static void deleteStudent() throws ClassNotFoundException, SQLException {
		...
		int res = StatementObj.getStmt().executeUpdate(delete);
		if (res == 1) {
